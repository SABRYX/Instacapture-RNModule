...
package com.reactnativeinstacaptureapp.instacapture;
...
public class instacaptureModule extends ReactContextBaseJavaModule {
    public static final String REACT_CLASS = "instacapture";
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put(MESSAGE_IS_ACTIVITY_RUNNING, "Is your activity running?");
        constants.put(ERROR_SCREENSHOT_CAPTURE_FAILED, "Screenshot capture failed");
    ...
    public void capture (@NonNull Activity activity,
        ...
        // https://facebook.github.io/react-native/docs/native-modules-android.html#the-toast-module
        Instacapture.capture(activity,screenCaptureListener,ignoredViews);
    }
